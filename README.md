...
**속삭임**(첫 화면에서 촛불을 움직이면 보이는 세 문장)은 `site.js`의 기본 60문장(미스터리 30 + 밤 감성 30) + 서가 상태로 만드는 문장(봉인 수·비공개 수·작품 장 수·최근 앱) + `site.whispers`에서 올 때마다 3개를 무작위로 뽑는다. 직전 방문에 나온 문장은 피한다.
